...
def fetch_weather_data(city_name="Sylhet", api_key=""):
    ...
    tz_map = {
        "Sylhet": 21600, "Dhaka": 21600, "Chittagong": 21600,
        "London": 3600, "New York": -14400, "Tokyo": 32400,
        "Sydney": 36000, "Paris": 7200, "Dubai": 14400,
        "Moscow": 10800, "Los Angeles": -25200, "Beijing": 28800
    }
    ...
    cond, desc, temp, hum, wind = condition_map.get(city_clean, ("clear", "CLEAR SKY", 25, 60, 10.0))
